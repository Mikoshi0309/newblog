...
!function ($) {
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        // if (this.options.showAddTag) {
        //     html.push(sprintf('<button class="btn btn-default" type="button" name="addtag" title="%s">',
        //         this.options.formatAddTag()),
        //         '<i class="glyphicon glyphicon glyphicon-plus icon-list-alt"></i>',
        //         '</button>');
        // }
