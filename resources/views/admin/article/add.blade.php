                    ...
                    <div class="col-md-9">
                        <form role="form" action="{{ route('article.store') }}" method="post"  enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="请填写标题" id="title" name="title" value="{{ old('title') }}">
                                @if ($errors->has('title'))
                                    <span class="has-error">
                            ...
                            <div class="form-group">
                                ...
                                <script id="editor" name="content" type="text/plain" style="width:860px;height:500px;">{!!  old('content') !!}</script>
